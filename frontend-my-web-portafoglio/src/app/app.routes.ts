...
import { TabellaAllTransaction } from './components/tabelle/tabella-all-transaction/tabella-all-transaction';

export const routes: Routes = [
  { path: '', component: HomePage, title: 'Home' },
  { path: 'uscite', component: Tabella, title: 'Tabella Uscite' },
  { path: 'entrate', component: TabellaEntrate, title: 'Tabella Entrate' },
  { path: 'sommario', component: TabellaAllTransaction, title: 'Tabella AllTransaction'},
];
